            ...
            <div class="grid grid-rows-11 w-full h-full">
                ...
                <div class="row-span-10">
                    <div class="grid grid-cols-12 grid-rows-9 w-full h-full">
                        ...
                        <div class="row-span-8 col-span-10 p-5 flex flex-col gap-5 overflow-y-auto overflow-x-hidden scroll-smooth overscroll-none">
                            <component v-for="message in messages" :is="message.role==='user'?'HumanMessage':'AIMessage'" :content="message.content"/>
                        </div>
                        <div class="row-span-8 col-span-1"></div>
